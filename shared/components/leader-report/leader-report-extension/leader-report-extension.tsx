...
import classes from './leader-report-extension.module.css';

export const LeaderReportExtension: FC = () => (
  <section className={classes.leaderReportExtension}>
    <div className="container">
      <div className="row">
        <div className={['col-12 col-md-6 text-center', classes.leaderReportExtensionItem].join(' ')}>
        ...
        <div
          className={['col-12 col-md-6 text-center mobile-margin-top-50', classes.leaderReportExtensionItem].join(' ')}
        >
      ...
      <div className="row mt-144">
        <div className={['col-12 col-md-6', classes.leaderReportExtensionContent].join(' ')}>
